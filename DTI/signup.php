            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="login-container">
                    <div class="login-header">
                        <h2 class="text-dark" style="font-weight: 700;">REGISTER <br> FORM</h2>
                    </div>
                    ...
                    <form name ="signupForm" action="" method="POST" onsubmit="return validateForm()">
                            ...
                            <div class="text-center">
                                <button type="submit" style="background-color: #01043A; width: 342px; height: 50px;" name="signup_btn" class="btn btn-primary">Sign Up</button>
                            </div>
                        </form>  
                </div>
            </div>
