...
if (file_put_contents($file_path, $imageBinary)) {
    // Insert certificate information into the database with hardcoded status
    $query = "INSERT INTO certificates (name, description, file_path, status) VALUES (?, ?, ?, 'Unarchived')";
